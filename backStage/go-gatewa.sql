...
create table go_gateway.gateway_service_info (
    ...
    `update_at`         datetime                     not null default '1971-01-01 00:00:00' comment '更新时间',
    `id_delete`         tinyint(4)                            default '0'                   comment '是否删除 1=删除'
...
(id,load_type,service_name,service_desc,create_at,update_at,id_delete)
values
...
insert into go_gateway.gateway_service_tcp_rule (id,service,port)
values
(171, 41, 8002),
(172, 42, 8003),
(173, 43, 8004),
