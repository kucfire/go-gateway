        ...
        <div style="margin-bottom:80px;">
          <el-form ref="form" :model="form" label-width="140px">
            ...
            <el-form-item label="支持HTTPS">
              ...
              <span style="color:#606266;font-weight: 700; width: 300px; padding-left: 50px; padding-right: 10px; text-align: right;">支持WEBSocket</span>
              <el-switch v-model="form.need_websocket">
              </el-switch>
              <span style="color:#606266;font-weight: 700;">支持StripURL</span>
