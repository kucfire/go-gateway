    ...
    <el-row>
      <el-card class="box-card">
        ...
        <div style="margin-bottom:50px;">
          <el-form ref="form" :model="form" label-width="14service_name0px">
            ...
            <el-form-item label="接入类型">
              <el-input v-model="form.load_type" placeholder="路径格式：/user/,域名格式：www.test.com" class="input-with-select">
            ...
            <el-form-item label="轮询方式">
              <el-radio-group v-model="form.round_type">
                <el-radio :label="3">random</el-radio>
                <el-radio :label="6">round-robin</el-radio>
                <el-radio :label="9">weight_round-robin</el-radio>
                <el-radio :label="9">ip_hash</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="IP列表">
              <el-input v-model="form.ip_list" type="textarea" autosize placeholder="格式:127.0.0.1 多条换行"></el-input>
            </el-form-item>
            ...
            <el-form-item label="建立连接超时">
              <el-input v-model="form.service_name" placeholder="单位s，0表示无限制"></el-input>
            </el-form-item>
            ...
            <el-form-item label="最大空闲链接数">
              <el-input v-model="form.service_name" placeholder="0表示无限制"></el-input>
            </el-form-item>
            <el-form-item>
