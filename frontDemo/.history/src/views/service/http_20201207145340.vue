          ...
          <el-form ref="form" :model="form" label-width="14service_name0px">
            ...
            <el-form-item label="接入类型">
              <el-input v-model="form.load_type" placeholder="路径格式：/user/,域名格式：www.test.com" class="input-with-select">
                ...
                v-model="form.rule_type" placeholder="请选择">
            ...
            <el-form-item label="IP白名单">
              <el-input v-model="form.url_rewrite" type="textarea" autosize placeholder="格式:127.0.0.1 多条换行，白名单优先级高于黑名单"></el-input>
            </el-form-item>
            <el-form-item label="IP黑名单">
              <el-input v-model="form.url_rewrite" type="textarea" autosize placeholder="格式:127.0.0.1 多条换行"></el-input>
            </el-form-item>
