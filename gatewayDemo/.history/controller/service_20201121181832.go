...
func ServiceRegister(group *gin.RouterGroup) {
	...
	group.POST("/service_add_http", service.ServiceHTTPAdd)
}
...
// @Summary 服务HTTP添加
// @Description 服务HTTP添加
// @Tags 服务管理
// @ID /service/service_http_add
// @Accept  json
// @Produce  json
// @Param body body dto.AdminLoginInput true "body"
// @Success 200 {object} middleware.Response{data=dto.AdminLoginInput} "success"
// @Router /service/service_http_add [post]
func (adminligin *ServiceController) ServiceHTTPAdd(c *gin.Context) {
