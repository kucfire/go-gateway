...
type AppAddInput struct {
	// 服务名称
	AppID string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,valid_service_name"`
	// 服务名称
	Name string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,valid_service_name"`
	// 服务名称
	Secret string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,valid_service_name"`
	// 服务名称
	WhiteIPS string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,valid_service_name"`
	// 服务名称
	QPD string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,valid_service_name"`
	// 服务名称
	QPS string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,valid_service_name"`
	// 服务名称
	IsDelete string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,valid_service_name"`
}
