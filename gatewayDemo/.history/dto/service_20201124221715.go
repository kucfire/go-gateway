...
type ServiceAddGRPCInput struct {
	...
	// 接入路径
	HeaderTransfor string `json:"header_transport" form:"header_transport" comment:"metadata转换" example:"" validate:"vaild_header_transfor"`
...
func (params *ServiceUpdateGRPCInput) ServiceUpdateGRPCInput(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}
