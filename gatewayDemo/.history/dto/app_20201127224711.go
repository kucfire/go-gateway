...
type AppAddInput struct {
	// 服务名称
	AppID string `json:"app_id" form:"app_id" comment:"租户id" example:"app_id_0" validate:"required"`
	// 服务名称
	Name string `json:"name" form:"name" comment:"租户名称" example:"app_id_0" validate:"required"`
	// 服务名称
	QPD string `json:"qpd" form:"qpd" comment:"日请求量限制" example:"app_id_0" validate:"required"`
	// 服务名称
	QPS string `json:"qps" form:"qps" comment:"每秒请求量限制" example:"app_id_0" validate:"required"`
	// 服务名称
...
type AppUpdateInput struct {
	// 自增ID
	ID int64 `json:"id" form:"id" comment:"自增id" example:"" validate:"required"`
	// 服务名称:需要ID进行校验
