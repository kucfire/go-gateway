...
type ServiceAddHTTPInput struct {
	...
	// 服务器限流
	ServerFlowLimit int `json:"service_flow_limit" form:"service_flow_limit" comment:"服务器限流" example:"" validate:"min=0"`
...
type ServiceUpdateHTTPInput struct {
	// ID
	ID int64 `json:"id" form:"id" comment:"服务ID" example:"62" validate:"required"`
