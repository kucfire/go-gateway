...
type ServiceAddHTTPInput struct {
	...
	// 接入类型
	RuleType int8 `json:"rule_type" form:"rule_type" comment:"接入类型" example:"" validate:""`
	// 接入路径
	Rule string `json:"rule" form:"rule" comment:"接入路径：域名或者前缀" example:"" validate:"required"`
	// 是否支持HTTPS, 1=支持
	NeedHTTPS int8 `json:"need_https" form:"need_https" comment:"是否支持HTTPS:1=支持" example:"" validate:""`
	// 是否启用strip_uri, 1=启用
	NeedStripURI int8 `json:"need_strip_uri" form:"need_strip_uri" comment:"启用strip_uri 1=启用" example:"" validate:""`
	// 是否支持websocket, 1=支持
	NeedWEBSocket int8 `json:"need_websocket" form:"need_websocket" comment:"是否支持websocket 1=支持" example:"" validate:""`
	...
	// 是否开启权限 1=开启
	OpenAuth int8 `json:"open_auth" form:"open_auth" comment:"是否开启权限 1=开启" example:"" validate:""`
	// 黑名单ip
	...
	RoundType int8 `json:"round_type" form:"round_type" comment:"轮询方式 0=random 1=round_robin 2=wieght_round_robin 3=ip_hash" example:"" validate:""`
	// ip列表
