...
type ServiceAddHTTPInput struct {
	...
	RoundType string `json:"round_type" form:"round_type" comment:"轮询方式 0=random 1=round_robin 2=wieght_round_robin 3=ip_hash" example:"" validate:"required"`
	// ip列表
	...
	// 建立连接超时，单位s
	UpstreamConnectTimeout string `json:"upstream_connect_timeout" form:"upstream_connect_timeout" comment:"建立连接超时，单位s" example:"" validate:"required"`
	// 获取header超时，单位s
	UpstreamHeaderTimeout string `json:"upstream_header_timeout" form:"upstream_header_timeout" comment:"获取header超时，单位s" example:"" validate:"required"`
	// 白名单ip
	UpstreamIdleTimeout string `json:"upstream_idle_timeout" form:"upstream_idle_timeout" comment:"链接最大空闲时间，单位s" example:"" validate:"required"`
	// 白名单ip
	UpstreamMaxIdle string `json:"upstream_max_idle" form:"upstream_max_idle" comment:"最大空闲链接数" example:"" validate:"required"`
}
