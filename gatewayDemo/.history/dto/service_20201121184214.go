...
type ServiceAddHTTPInput struct {
	// 服务名称
	ServiceName string `json:"service_name" form:"service_name" example:"" validate:"required"`
	// 服务描述
	ServiceDesc string `json:"serbice_desc" form:"serbice_desc" example:"" validate:"required"`
}
