...
type ServiceAddHTTPInput struct {
	// 服务名称
	ServiceName string `json:"service_name" form:"service_name" comment:"服务ID" example:"" validate:"required"`
	// 服务描述
	ServiceDesc string `json:"serbice_desc" form:"serbice_desc" comment:"服务ID" example:"" validate:"required"`
}
