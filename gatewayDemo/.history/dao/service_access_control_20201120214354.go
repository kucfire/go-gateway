...
type ServiceAccessControl struct {
	...
	white_host_home     time.Time `json:"update_at" gorm:"column:update_at" description:"更新时间"`
	clientip_flow_limit time.Time `json:"create_at" gorm:"column:create_at" description:"创建时间"`
	service_flow_limit  int8      `json:"is_delete" gorm:"column:is_delete" description:"是否删除; 0:否; 1:是"`
}
