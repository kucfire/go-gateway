...
type ServiceHTTPRule struct {
	...
	NeedStripURL   int    `json:"need_strip_url" gorm:"column:need_strip_url" description:"启用strip_url 1=启用"`
	NeedStripURI   int    `json:"need_strip_uri" form:"need_strip_uri" comment:"启用strip_uri 1=启用"`
