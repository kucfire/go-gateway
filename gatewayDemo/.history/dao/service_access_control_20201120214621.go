...
type ServiceAccessControl struct {
	...
	WhiteHostHome     time.Time `json:"white_host_home" gorm:"column:white_host_home" description:"白名单主机"`
	ClientipFlowLimit time.Time `json:"clientip_flow_limit" gorm:"column:clientip_flow_limit" description:"客户端ip限流"`
	ServiceFlowLimit  int8      `json:"service_flow_limit" gorm:"column:service_flow_limit" description:"服务器限流"`
}
