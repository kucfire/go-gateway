...
type AppInfo struct {
	...
	WhiteIps  string    `json:"white_ips" gorm:"column:secret" description:"密钥"`
	QPD       string    `json:"qpd" gorm:"column:secret" description:"密钥"`
	QPS       string    `json:"qps" gorm:"column:secret" description:"密钥"`
