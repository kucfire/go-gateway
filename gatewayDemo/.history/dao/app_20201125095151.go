...
type AppInfo struct {
	...
	WhiteIps  string    `json:"secret" gorm:"column:secret" description:"密钥"`
	QPD       string    `json:"secret" gorm:"column:secret" description:"密钥"`
	QPS       string    `json:"secret" gorm:"column:secret" description:"密钥"`
